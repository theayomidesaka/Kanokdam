            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-12">
              <div className="space-y-4">
                ...
                <ul className="space-y-3 text-sm text-gray-400 font-medium">
                  ...
                  <li><Link to="/"           className="hover:text-white transition-colors block">Services</Link></li>
                  <li><Link to="/generators" className="hover:text-white transition-colors block">Product</Link></li>
                  <li><Link to="/quote"      className="hover:text-white transition-colors block">Contact Us</Link></li>
                </ul>
              </div>
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-3 text-sm text-gray-400 font-medium">
                  <li><span className="hover:text-white transition-colors cursor-pointer block">Privacy Policy</span></li>
                  <li><span className="hover:text-white transition-colors cursor-pointer block">Terms & Conditions</span></li>
                  <li><span className="hover:text-white transition-colors cursor-pointer block">Warranty Policy</span></li>
                  <li><span className="hover:text-white transition-colors cursor-pointer block">Health & Safety Policy</span></li>
                </ul>
              </div>
