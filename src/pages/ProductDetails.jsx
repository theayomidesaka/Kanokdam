...
export default function ProductDetails({ setRoute, productId, setSelectedProductId }) {
  ...
  /* Extra spec rows behind "View More" */
  const extraSpecs = [
    ...
    <div className="w-full bg-white py-12 font-sans text-left">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            ...
            <div className="border border-gray-200 rounded-xl overflow-hidden">
              <div className="text-center py-2 border-b border-gray-200">
                <span className="font-noto text-[10px] font-bold uppercase tracking-widest text-gray-400">
                  Warranty
                </span>
              </div>
          ...
          <div className="space-y-6">
            ...
            <h1 className="font-noto text-3xl sm:text-4xl font-black text-[#0B0F19] leading-tight">
              ...
              {generator.capacityKVA > 0 && (
                <span> ({generator.capacityKVA}kVA)</span>
              )}
            </h1>

            {/* Full description — justified */}
            <p className="font-noto text-sm text-gray-600 leading-relaxed text-justify">
              {generator.description}
            </p>

            {/* ── Technical Specifications ── */}
            <div className="pt-2">
              <h2 className="font-noto text-xl font-black text-[#0B0F19] mb-5">
                Technical Specifications
              </h2>
              ...
              {extraSpecs.length > 0 && (
                <button
                  ...
                  className="flex items-center gap-1.5 font-noto text-sm font-semibold text-gray-700 hover:text-brand-red transition-colors mt-5"
                >
        ...
        <div className="border-t border-gray-200 pt-16">
          <h2 className="font-noto text-2xl font-black text-[#0B0F19] uppercase tracking-tight mb-8">
            You May Also Like
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {recommendations.map((gen, idx) => {
                ...
                ? [
                    {
                      label: 'ATS & Sync\nPanels',
                      icon: (
                        <svg viewBox="0 0 40 40" fill="none" className="w-9 h-9 mx-auto">
                          <rect x="6" y="10" width="28" height="20" rx="3" stroke="#111827" strokeWidth="2.2"/>
                          <line x1="14" y1="10" x2="14" y2="30" stroke="#111827" strokeWidth="2"/>
                          <line x1="26" y1="10" x2="26" y2="30" stroke="#111827" strokeWidth="2"/>
                    ...
                    },
                    {
                      ...
                      icon: (
                        <svg viewBox="0 0 40 40" fill="none" className="w-9 h-9 mx-auto">
                          <ellipse cx="20" cy="22" rx="12" ry="9" stroke="#111827" strokeWidth="2.2"/>
                          <path d="M20 13V8" stroke="#111827" strokeWidth="2.2" strokeLinecap="round"/>
                          <path d="M8 22H4M36 22h-4" stroke="#111827" strokeWidth="2" strokeLinecap="round"/>
                        </svg>
                      )
                    },
                    {
                      ...
                      icon: (
                        <svg viewBox="0 0 40 40" fill="none" className="w-9 h-9 mx-auto">
                          <path d="M10 30L30 10" stroke="#111827" strokeWidth="2.2" strokeLinecap="round"/>
                          <circle cx="12" cy="12" r="5" stroke="#111827" strokeWidth="2.2"/>
                          <circle cx="28" cy="28" r="5" stroke="#111827" strokeWidth="2.2"/>
                        </svg>
                      )
                    },
                  ]
                : [
                    {
                      ...
                      icon: (
                        <svg viewBox="0 0 40 40" fill="none" className="w-9 h-9 mx-auto">
                          <path d="M20 5l3.09 9.26H32l-7.27 5.28 2.77 8.52L20 23.4l-7.5 4.66 2.77-8.52L8 14.26h8.91z" stroke="#111827" strokeWidth="2" strokeLinejoin="round"/>
                          <path d="M14 28l-2 7M26 28l2 7M20 28v7" stroke="#111827" strokeWidth="2" strokeLinecap="round"/>
                        </svg>
                      )
                    },
                    {
                      ...
                      icon: (
                        <svg viewBox="0 0 40 40" fill="none" className="w-9 h-9 mx-auto">
                          <rect x="6" y="26" width="28" height="6" rx="2" stroke="#111827" strokeWidth="2.2"/>
                          <path d="M12 26V18c0-1.1.9-2 2-2h12c1.1 0 2 .9 2 2v8" stroke="#111827" strokeWidth="2.2"/>
                          <path d="M16 16v-4a4 4 0 018 0v4" stroke="#111827" strokeWidth="2.2"/>
                        </svg>
                      )
                    },
                    {
                      ...
                      icon: (
                        <svg viewBox="0 0 40 40" fill="none" className="w-9 h-9 mx-auto">
                          <circle cx="20" cy="20" r="13" stroke="#111827" strokeWidth="2.2"/>
                          <path d="M20 20l6-6" stroke="#111827" strokeWidth="2.2" strokeLinecap="round"/>
                          <circle cx="20" cy="20" r="2.5" fill="#111827"/>
                          <path d="M20 10v2M10 20h2M20 30v-2M30 20h-2" stroke="#111827" strokeWidth="2" strokeLinecap="round"/>
                        </svg>
                      )
                    },
                  ];
              ...
              return (
                <div
                  key={gen.id}
                  className="bg-white rounded-2xl overflow-hidden border border-gray-100 flex flex-col hover:shadow-lg transition-shadow duration-300"
                >
                  {/* Image */}
                  <div className="relative h-64 sm:h-72 overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm rounded-full px-3 py-1.5 flex items-center gap-1.5 shadow-sm">
                      <svg className="w-3 h-3 text-brand-red shrink-0" viewBox="0 0 12 12" fill="currentColor">
                        <circle cx="6" cy="6" r="5"/>
                      </svg>
                      <span className="font-noto text-[10px] font-bold uppercase tracking-wider text-gray-800">
                        Peak Performance
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    <h3 className="font-noto text-xl sm:text-2xl font-black text-[#0B0F19] uppercase leading-tight mb-3">
                      {gen.name}
                    </h3>
                    <p className="font-noto text-sm text-gray-500 leading-relaxed line-clamp-3 mb-6">
                      {gen.description}
                    </p>
                    ...
                    <div className="grid grid-cols-3 divide-x divide-gray-200 mb-6">
                      {features.map((feat, fi) => (
                        <div key={fi} className="flex flex-col items-center text-center px-2 gap-2">
                          {feat.icon}
                          <span className="font-noto text-[10px] sm:text-xs font-semibold text-gray-600 leading-snug whitespace-pre-line">
                            {feat.label}
                          </span>
                        </div>
                      ))}
