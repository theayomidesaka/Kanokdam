...
export default function Home({ setRoute, setSelectedProductId }) {
  ...
  // Helper to get custom title & description for featured cards
  const getFeaturedCardDetails = (id, defaultName, defaultDesc) => {
    switch (id) {
      case 'sp-50':
        return {
          title: 'KANOKDAMYORC SP50',
          desc: 'Affordability meets performance at its peak. YORC generating sets are engineered for demanding industrial environments, offering high power output and robust reliability.'
        };
      case 'sp-60':
        return {
          title: 'KANOKDAMYORC SP60',
          desc: 'Dependable and trusted worldwide, Perkins engines offer unparalleled longevity and efficient performance, ideal for critical power backup solutions.'
        };
      case 'accessories':
        return {
          title: 'ACCESSORIES',
      ...
      default:
        return { title: defaultName, desc: defaultDesc };
    }
  };
  ...
  return (
    <div className="w-full bg-[#FFFFFF] font-sans text-left">
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 bg-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {featured.map((gen) => (
            <div 
              key={gen.id} 
              className="h-full rounded-[1.75rem] border border-gray-200 bg-[#EAEAEA] overflow-hidden flex flex-col justify-between hover:shadow-md transition-all duration-300 relative"
            >
              
              {/* Header overlay badge pill */}
              ...
              {/* Title, description, features and CTA */}
              <div className="p-8 text-left flex-1 flex flex-col justify-between space-y-6">
                ...
                <div className="grid grid-cols-3 gap-0 text-center items-start pt-6 border-t border-gray-300">
                  ...
                  <div className="px-1 border-r border-gray-300 flex flex-col items-center justify-between min-h-[5.5rem]">
                    ...
                    <span className="font-noto text-[10px] font-bold leading-tight text-[#121827] uppercase tracking-tight mt-3">
                      Available in popular KVA ratings
                    </span>
                  </div>
      ...
      <section 
        className="w-full text-white py-24 border-t border-white/5"
        style={{ backgroundColor: 'hsla(223, 37%, 11%, 1)' }}
      >
            ...
            <div className="lg:col-span-6 text-left lg:pl-4 space-y-8">
              <div className="space-y-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-noto text-xs font-bold text-brand-red uppercase tracking-wider">
                    WHY KANOKDAM
                  </span>
                </div>
                ...
                {[
                  {
                    ...
                    desc: "Switches to backup power within 10 seconds of grid failure. Zero manual intervention needed your operations never pause."
                  },
                  {
                    num: "02",
                    title: "SMART FUEL MANAGEMENT",
                    desc: "Adaptive load sensing optimizes fuel consumption in real time, delivering up to 40% better fuel economy versus standard generators."
                  },
                  {
                    num: "03",
                    title: "REMOTE MONITORING DASHBOARD",
                    desc: "Monitor output, fuel levels, and system health from your phone. Get alerts before problems become failures."
                  }
                ].map((item, index) => (
                  <div 
                    key={item.num} 
                    className={`py-6 ${index !== 2 ? 'border-b border-white/20' : ''}`}
                  >
                    <div className="flex items-start">
                      <span className="font-noto text-lg sm:text-[1.25rem] font-bold text-cyan-400 mr-4 mt-[3px] leading-none shrink-0">
                        {item.num}
                      </span>
                      <div className="flex-1 space-y-2">
                        <h4 className="font-noto text-[1.125rem] sm:text-[1.25rem] font-extrabold text-white tracking-wide uppercase leading-none">
                          {item.title}
                        </h4>
                        <p className="font-noto text-[0.875rem] text-white/80 leading-relaxed font-normal max-w-xl">
                          {item.desc}
                        </p>
                      </div>
                    </div>
      ...
      <section className="w-full bg-[#EAEAEA] py-24 border-t border-gray-200">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
            ...
            {/* Left Card: Diesel & Gas Generator Expert */}
              ...
              <div className="p-8 flex-1 flex flex-col justify-between space-y-6">
                <div className="flex justify-between items-start">
                  ...
                  <button 
                    ...
                    className="text-[#E53E3E] hover:scale-110 transition-transform cursor-pointer"
                  >
            ...
            <div className="flex flex-col gap-8 justify-between">
              ...
              <div className="bg-white rounded-[1.75rem] p-8 border border-gray-100 shadow-sm flex flex-col justify-between space-y-16 flex-1">
                ...
                <div className="space-y-4">
                  <h3 className="font-noto text-[1.5rem] font-extrabold text-[#111827] uppercase tracking-tight leading-none">
                    LOGISTICS & INSTALLATION
                  </h3>
                  <p className="font-noto text-[0.875rem] text-[#121827]/85 font-medium leading-relaxed">
                    Full nationwide delivery available with seamless, professional installation and setup. Our team ensures 100% satisfaction guarantee.
                  </p>
                </div>
              </div>

              {/* Card 3: Preventive Maintenance (AMC) */}
              <div className="bg-white rounded-[1.75rem] p-8 border border-gray-100 shadow-sm flex flex-col justify-between space-y-16 flex-1">
                <div className="flex justify-between items-start">
                ...
                <div className="space-y-4">
                  <h3 className="font-noto text-[1.5rem] font-extrabold text-[#111827] uppercase tracking-tight leading-none">
                    PREVENTIVE MAINTENCE (AMC)
                  </h3>
                  <p className="font-noto text-[0.875rem] text-[#121827]/85 font-medium leading-relaxed">
                    Our Annual Maintenance Contract (AMC) keeps your generating set in peak condition year-round, minimizing downtime and ensuring longevity.
                  </p>
                </div>
              </div>
      ...
      {/* 6. Leading the Way (About section) */}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-6 text-left space-y-6 flex flex-col justify-center">
              <div>
                <h3 className="font-noto text-[1.5rem] font-bold text-brand-red mb-4">
                  About Kanokdam Limited
                </h3>
                <p className="font-noto text-[1rem] text-[#121827] leading-relaxed font-semibold">
                  Kanokdam Limited is built on decades of experience in Mechanical and Electrical Engineering Works. Our mission is to utilize the latest processing solutions and expertise to ensure you receive sufficient, reliable power supply without worry. We are committed to building bigger, better, faster, and stronger power products than ever before.
                </p>
              </div>
